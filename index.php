                ...
                <tr> 
                    ...
                    <td> 
                        <select id="ville" name="ville" required> 
                            ...
                            <option value="Azamour">Azamour</option> 
    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td>
                    <?php if ($id): ?>
                        <a href="controller/deleteEtudiant.php?id=<?php echo urlencode($id); ?>">Supprimer</a> 
                        <a href="controller/updateEtudiant.php?id=<?php echo urlencode($id); ?>">Modifier</a>
                    <?php else: ?>
